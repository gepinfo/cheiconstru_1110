...
import  {service}   from './contractor.service';

class Contractor extends React.Component<any, any> {
    test = new service ("");
    ...
    Create  () {
    this.test.Create(this.state.contractors).then((data:any) => {
    ...
    return(
    <>
        <h2 className="screen-align">contractor</h2>
        <div>
    <div id="template-i1zl">
        <div id="template-ijrp">
                                ...
                                <div id="template-iq8zg" className="gjs-cell">
                                    <div id="template-iufwi" className="gjs-row">
                                        ...
                                        <div id="template-i1nbl" className="gjs-cell">
                                            <div type="button" id="template-idb36" onClick={()=>this.Create()} className="btn btn-primary "></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
